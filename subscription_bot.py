...
def git_commit_and_push():
    ...
    pull --rebase (با retry فوری روی برخورد push) که candle_engine.py هم استفاده می‌کنه، تا
    این دو دیگه هیچ‌وقت دو نسخه‌ی مستقل/drift‌شده از همین منطق نداشته باشن (توضیح کامل در
